...
class TestWalletEntry(unittest.TestCase):
    def test_from_xml_row(self):
        ...
        self.assertEquals(entry.ref_id, 13046672950)
        self.assertEquals(entry.type_id, 17)
        self.assertEquals(entry.amount, 0.99)
        self.assertEquals(entry.date, datetime(2016, 9, 13, 12, 13, 52))
